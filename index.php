...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    ...
    <span class="navbar-text">Online Service Management System</span>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      ...
      <p>
        OSMS Services is Bangladesh’s leading chain of multi-brand Electronics and Electrical service
        workshops offering
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Amirul islam</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Sabbir islam</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-center">
        ...
        <br><br>
        <strong>Chittagong Branch:</strong> <br>
        OSMS Pvt Ltd, <br>
        Andorkilla, Chittagong <br>
        Chittagong - 2002 <br>
        Phone: +00000000 <br>
        <a href="#" target="_blank">www.osms.com</a> <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Amirul &copy; 2020.
          </small>
